...
public class MainActivity extends AppCompatActivity {
	...
	private void makeLine( String text, String[] out ) {
		...
		this.inputOperator[ pNum ].setText( out[2] + ": <<" + out[ 0 ] + ":" + out[ 3 ] + out[ 4 ] + out[ 5 ] );
	...
	private void viewMaker(int pNum){
		...
		this.inputOperator[ pNum ].setGravity( Gravity.LEFT );
		this.inputOperator[ pNum ].setTextColor( 0xff000000 );
		this.inputOperator[ pNum ].setTextSize( upperFontSize );
		LinearLayout.LayoutParams io = new LinearLayout.LayoutParams( 0, MP );
		io.weight = 4;
		this.inputOperator[ pNum ].setLayoutParams( io );
		...
		this.inputNum[ pNum ].setTextSize( upperFontSize );
		LinearLayout.LayoutParams in = new LinearLayout.LayoutParams( 0, MP );
		in.weight = 5;
		this.inputNum[ pNum ].setLayoutParams( in );
